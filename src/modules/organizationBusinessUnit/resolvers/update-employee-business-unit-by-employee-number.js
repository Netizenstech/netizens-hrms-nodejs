...
const updateEmployeeBusinessUnit = async (_, args, ctx) => {
    try {
        ...
        let updatedEmployee = await EmployeeModel.update({ organization_business_unit_id: args.data.organization_business_unit_id }, { where: { employee_no: { [Sequelize.Sequelize.Op.in]: args.data.employee_numbers }, organization_id: args.data.organization_id }, returning: true });
...
module.exports = updateEmployeeBusinessUnit;
