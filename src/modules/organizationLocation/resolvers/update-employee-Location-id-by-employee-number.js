...
const updateEmployeeLocation = async (_, args, ctx) => {
    try {
        ...
        let updatedEmployee = await EmployeeModel.update({ organization_location_id: args.data.organization_location_id }, { where: { employee_no: { [Sequelize.Sequelize.Op.in]: args.data.employee_numbers }, organization_id: args.data.organization_id }, returning: true });
...
module.exports = updateEmployeeLocation;
